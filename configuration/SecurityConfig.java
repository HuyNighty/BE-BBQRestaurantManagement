...
public class SecurityConfig {
    ...
    public SecurityConfig(CustomerJwtDecoder customerJwtDecoder, CustomAccessDeniedHandler customAccessDeniedHandler, JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint) {
